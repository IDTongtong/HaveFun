...
import com.lanou.tong.fun.tool.scviewpager.DotsView;
import com.lanou.tong.fun.tool.scviewpager.SCPositionAnimation;
import com.lanou.tong.fun.tool.scviewpager.SCViewAnimation;
import com.lanou.tong.fun.tool.scviewpager.SCViewAnimationUtil;
import com.lanou.tong.fun.tool.scviewpager.SCViewPager;
import com.lanou.tong.fun.tool.scviewpager.SCViewPagerAdapter;

/**
 * Created by zt on 2016/3/25.
 */
public class GuideActivity extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.guide_enter_btn);

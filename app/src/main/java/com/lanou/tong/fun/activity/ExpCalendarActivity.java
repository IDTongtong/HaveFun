...
import com.lanou.tong.fun.tool.calendarviewtools.mcalendarview.listeners.OnExpDateClickListener;
import com.lanou.tong.fun.tool.calendarviewtools.mcalendarview.listeners.OnMonthScrollListener;
import com.lanou.tong.fun.tool.calendarviewtools.mcalendarview.views.ExpCalendarView;

import java.util.Calendar;


public class ExpCalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exp_calendar_activity);
